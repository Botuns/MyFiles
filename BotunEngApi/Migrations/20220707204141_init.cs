        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractDuration = table.Column<TimeSpan>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "text", nullable: true),
                    Password = table.Column<string>(type: "text", nullable: true),
                    WorkerRefNo = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerClients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkerClients_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkerClients_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerClients_ClientId",
                table: "WorkerClients",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkerClients_WorkerId",
                table: "WorkerClients",
                column: "WorkerId");
